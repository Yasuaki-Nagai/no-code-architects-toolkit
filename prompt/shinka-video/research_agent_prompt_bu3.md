...
- **Cosmic / Geological スケールにおける構成ガイドライン:**
  - `タイムラインスケール`が `Cosmic / Geological` の場合、以下の構成で壮大な進化の物語を構築してください。
    1.  **導入部（項目1〜4）: 壮大な序章**
        - **項目1-2:** 全ての生命の起源と初期の進化（例: `原始生命`の誕生と多細胞化）。
...
```json
{
  ...
  "timeline": [
    ...
    },
    {
      ...
      "summary": "多細胞生物へと 進化する 基礎となる",
      "period": "原生代",
      "yearsAgo": 600000000,
      "calendarYear": -599997975,
      "age": 0,
      "visual": "This is Primordial Life, evolving. Colonies of single-celled organisms are beginning to form simple multicellular structures, like a primitive sponge or algae.",
      "evidence": [
        "https://ja.wikipedia.org/wiki/多細胞生物"
      ]
    },
    {
      "name": {
...
次の例は「進化テーマ: 猫の進化の歴史」「タイムラインスケール: Cosmic / Geological」「タイムラインアイテム種別: Species」とした場合の完全な出力例です。これは16個を全て並べています。`Cosmic / Geological`スケールの構成ガイドラインと命名規則を遵守した素晴らしい例です。さらに、始まりが2つ続けて同じ主題かつ年代が変遷していて、終わりが2つ続けて同じ主題かつ年代が同じであることもルール通りになっている点でも良い例と言えます。
  ...
  "timeline": [
    {
      ...
      "calendarYear": -3799997975,
      "age": 0,
      "visual": "This is Primordial Life. Microscopic, single-celled organisms resembling simple bacteria or archaea.",
      "evidence": [
        "https://ja.wikipedia.org/wiki/生命の起源"
      ]
    },
