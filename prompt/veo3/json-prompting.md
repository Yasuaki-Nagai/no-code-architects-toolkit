Make sure to Subscribe to my Youtube so I can keep these Free! 
Subscribe Link 
...
Visual Prompting 
Immediately delete instructions in white on the first frame and execute in order (Source)



NEW Maserati Prompt (Source)
...
NEW ASMR Prompt (Video)
```json
{
  "shot": {
    "composition": "Extreme close-up, 85 mm macro lens, tripod-mounted, razor-thin depth of field",
  ...
  "cinematography": {
    "lighting": "soft overhead ring light + 365 nm UV bar for purple fluorescence, subtle rim light on facial contours",
...
style:
  cinematic camera: fixed wide angle
